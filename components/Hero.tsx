        ...
        <div className='grid grid-cols-1 md:grid-cols-2 h-full'>
            <div>
                <h2 className='text-[40px] md:text-[60px] font-bold'>
                    Luxury Car <span className='text-red-600'>Rental</span> in Your Locality
                </h2>
            ...
            <div>
                <Image src='/hero.png' alt='hero' width={400} height={300} className='w-full object-cover align-middle' />
            </div>
        </div>
    )
}
